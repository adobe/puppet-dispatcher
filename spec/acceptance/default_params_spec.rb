  ...
  context 'default settings' do
    ...
    describe file("#{conf_path}/dispatcher.00-default.inc.any") do
      ...
      describe 'renders' do
        ...
        its(:content) { is_expected.not_to match %r{/secure} }
      ...
      describe 'filters' do
        ...
        its(:content) { is_expected.not_to match %r{/method} }
        its(:content) { is_expected.not_to match %r{/query} }
        its(:content) { is_expected.not_to match %r{/protocol} }
        its(:content) { is_expected.not_to match %r{/path} }
        its(:content) { is_expected.not_to match %r{/selectors} }
        its(:content) { is_expected.not_to match %r{/extension} }
        its(:content) { is_expected.not_to match %r{/suffix} }
      end
      ...
      describe 'cache' do
        ...
        its(:content) { is_expected.to match %r{\s{6}/0000 \{ /type "deny" /glob "\*\.\*\.\*\.\*" \}$} }
